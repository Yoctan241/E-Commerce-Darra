...
export default function ProductGrid({ onAddToCart, onViewDetails }: ProductGridProps) {
  ...
  const filterProducts = () => {
    ...
    // Appliquer les filtres du composant ProductFilters
                ...
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex bg-white rounded-lg shadow-sm border">
                      <Button
                        variant={displayCurrency === 'FCFA' ? 'default' : 'ghost'}
                        size="sm"
                        onClick={() => setDisplayCurrency('FCFA')}
                        className={displayCurrency === 'FCFA' ? 'bg-[#2d7a3e] text-white' : 'text-gray-600'}
                      >
                        FCFA
                      </Button>
                      <Button
                        ...
                        className={displayCurrency === 'EUR' ? 'bg-[#2d7a3e] text-white' : 'text-gray-600'}
                      >
                        EUR
                      </Button>
                    </div>
